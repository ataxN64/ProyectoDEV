...
<script>
	$(document).ready(function() {
		$('.delete_data').click(function() {
			_conf("Seguro desear eliminar este usuario permanentemente?", "delete_user", [$(this).attr('data-id')])
		})
		$('.table td,.table th').addClass('py-1 px-2 align-middle')
		$('.table').dataTable();
		$('.verify_user').click(function() {
			_conf("Seguro deseas verificar <b>" + $(this).attr('data-name') + "<b/>?", "verify_user", [$(this).attr('data-id')])
		})
	})
