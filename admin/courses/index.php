	...
	<div class="card-header">
		...
		<?php if ($_settings->userdata('type') == 1) : ?>
			<div class="card-tools">
				<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span> Agregar Curso</a>
			</div>
		<?php endif; ?>
	</div>
	<div class="card-body">
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td class="">
									<p class="m-0 truncate-1"><?php echo $row['department'] ?></p>
								</td>
								<td class="">
...
<script>
	$(document).ready(function() {
		$('#create_new').click(function() {
			uni_modal("Agregar Curso", "courses/manage_course.php")
		})
		$('.view_data').click(function() {
			uni_modal("Curso", "courses/view_course.php?id=" + $(this).attr('data-id'))
		})
		$('.edit_data').click(function() {
			uni_modal("Actualizar Información Curso", "courses/manage_course.php?id=" + $(this).attr('data-id'))
		})
		$('.delete_data').click(function() {
			_conf("¿Estás seguro de eliminar este curso de forma permanente?", "delete_course", [$(this).attr('data-id')])
		})
