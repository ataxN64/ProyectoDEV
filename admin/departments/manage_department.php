...
<div class="container-fluid">
    <form action="" id="department-form">
        ...
        <div class="form-group">
            <label for="name" class="control-label">Aula / Salon</label>
            <input type="text" name="name" id="name" class="form-control form-control-border" placeholder="Enter Department Name" value="<?php echo isset($name) ? $name : '' ?>" required>
        </div>
        <div class="form-group">
