...
<div class="card card-outline card-primary rounded-0 shadow">
	...
	<div class="card-body">
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td align="center">
									<a href="./?page=students/view_student&id=<?= $row['id'] ?>" class="btn btn-flat btn-default btn-sm border"><i class="fa fa-eye"></i> Ver</a>
								</td>
							</tr>
						<?php endwhile; ?>
					</tbody>
		...
		<center>
			...
			<a href="./?page=students/manage_student" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span> Agregar Estudiante</a>
		</div>
		</center>
	</div>
</div>
